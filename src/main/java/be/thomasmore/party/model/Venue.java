...
public class Venue {
    ...
    public Venue(String venueName, String linkMoreInfo, int capacity, boolean foodProvited, boolean indoor, boolean outdoor, boolean freeParkingAvailable, String city, double distanceFromPublicTransportInKm) {

        this.venueName = venueName;
        this.linkMoreInfo = linkMoreInfo;
        this.capacity = capacity;
        this.foodProvited = foodProvited;
        this.indoor = indoor;
    ...
    public boolean isFoodProvited() {
        return foodProvited;
    }

    public void setFoodProvited(boolean foodProvited) {
        this.foodProvited = foodProvited;
    }
